...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <fieldset class="register">
                    <div>
                        ...
                        <asp:RequiredFieldValidator ControlToValidate="Department" CssClass="failureNotification"
                            ...
                            ToolTip="Please specify the staff department." ValidationGroup="ValidationGroup">
                            <asp:Image ImageAlign="TextTop" ImageUrl="~/Images/icons/error.png" runat="server" />
                            Please specify the staff department.
                        </asp:RequiredFieldValidator>
                    </div>
                    <div class="clear topPadding">
                        <asp:CheckBox ID="IsFellow" runat="server" Text="This staff member is a fellow" ValidationGroup="ValidationGroup" />
                    </div>
                </fieldset>
            </asp:Panel>
            ...
            <%-- / Staff Information --%>
            <div>
                <asp:Button CssClass="buttons" runat="server" Text="Create User" ValidationGroup="ValidationGroup"
