<%@ Page AutoEventWireup="true" CodeFile="Register.aspx.cs" Culture="en-SG" Inherits="Guest.Register"
        ...
        <ContentTemplate>
            ...
            <asp:Panel CssClass="collapsePanel" ID="PersonalInfoContent" runat="server">
                <fieldset class="register">
                    <%-- NRIC --%>
                    <div>
                        <asp:Label ID="Label1" AssociatedControlID="NRIC" runat="server" Text="* NRIC: " />
                        <asp:TextBox CssClass="textEntry" ID="NRIC" runat="server" />
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="NRIC" CssClass="failureNotification"
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="NRIC" CssClass="failureNotification"
                        ...
                        <asp:CustomValidator ID="CustomValidator1" ControlToValidate="NRIC" CssClass="failureNotification" Display="Dynamic"
                            ErrorMessage="NRIC already in use." OnServerValidate="NricNotExists" runat="server"
                            ToolTip="NRIC already in use." ValidationGroup="ValidationGroup">
                            <asp:Image ID="Image3" ImageAlign="TextTop" ImageUrl="~/Images/icons/error.png" runat="server" />
                            NRIC already in use.
                        </asp:CustomValidator>
                    </div>
                    <%-- / NRIC --%>
                    ...
                    <div class="topPadding">
                        <asp:Label ID="Label2" AssociatedControlID="FirstName" runat="server" Text="* First Name: " />
                        <asp:TextBox CssClass="textEntry" ID="FirstName" runat="server" />
                        <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" Enabled="True" FilterType="LowercaseLetters, UppercaseLetters"
                            runat="server" TargetControlID="FirstName" />
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="FirstName" CssClass="failureNotification"
                            ...
                            <asp:Image ID="Image4" ImageAlign="TextTop" ImageUrl="~/Images/icons/error.png" runat="server" />
                            Please enter your first name.
                        </asp:RequiredFieldValidator>
                        <asp:CustomValidator ID="CustomValidator2" ControlToValidate="FirstName" CssClass="failureNotification"
                            ...
                            <asp:Image ID="Image5" ImageAlign="TextTop" ImageUrl="~/Images/icons/error.png" runat="server" />
                    ...
                    <%-- Middle Name --%>
                    <div class="topPadding">
                        <asp:Label ID="Label3" AssociatedControlID="MiddleName" runat="server" Text="Middle Name: " />
                        <asp:TextBox CssClass="textEntry" ID="MiddleName" runat="server" />
                        <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" Enabled="True" FilterType="LowercaseLetters, UppercaseLetters"
                            runat="server" TargetControlID="MiddleName" />
                        <asp:CustomValidator ID="CustomValidator3" ControlToValidate="MiddleName" CssClass="failureNotification"
                            ...
                            <asp:Image ID="Image6" ImageAlign="TextTop" ImageUrl="~/Images/icons/error.png" runat="server" />
                    ...
                    <%-- Last Name --%>
                    <div class="topPadding">
                        <asp:Label ID="Label4" AssociatedControlID="LastName" runat="server" Text="* Last Name: " />
                        <asp:TextBox CssClass="textEntry" ID="LastName" runat="server" />
                        <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" Enabled="True" FilterType="LowercaseLetters, UppercaseLetters"
                            runat="server" TargetControlID="LastName" />
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="LastName" CssClass="failureNotification"
                            ...
                            <asp:Image ID="Image7" ImageAlign="TextTop" ImageUrl="~/Images/icons/error.png" runat="server" />
                            Please enter your last name.
                        </asp:RequiredFieldValidator>
                        <asp:CustomValidator ID="CustomValidator4" ControlToValidate="LastName" CssClass="failureNotification"
                            ...
                            <asp:Image ID="Image8" ImageAlign="TextTop" ImageUrl="~/Images/icons/error.png" runat="server" />
                    ...
                    <%-- Gender --%>
                    <div class="topPadding">
                        <asp:Label ID="Label5" AssociatedControlID="Gender" runat="server" Text="* Gender: " />
                        <asp:RadioButtonList CssClass="float" ID="Gender" RepeatDirection="Horizontal" runat="server">
                            <asp:ListItem Text="Male" Value="m" />
                            <asp:ListItem Text="Female" Value="f" />
                        </asp:RadioButtonList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="Gender" CssClass="failureNotification"
                            Display="Dynamic" ErrorMessage="Please specify your gender." runat="server" ToolTip="Please specify your gender."
                            ValidationGroup="ValidationGroup">
                            <asp:Image ID="Image9" ImageAlign="TextTop" ImageUrl="~/Images/icons/error.png" runat="server" />
                            Please specify your gender.
                        </asp:RequiredFieldValidator>
                        <asp:CustomValidator ID="CustomValidator5" ControlToValidate="Gender" CssClass="failureNotification" Display="Dynamic"
                            ErrorMessage="Please specify a valid gender." OnServerValidate="IsGenderValid"
                            runat="server" ToolTip="Please specify a valid gender." ValidationGroup="ValidationGroup">
                            <asp:Image ID="Image10" ImageAlign="TextTop" ImageUrl="~/Images/icons/error.png" runat="server" />
                    ...
                    <div class="clear topPadding">
                        <asp:Label ID="Label6" AssociatedControlID="Prefix" runat="server" Text="* Salutation: " />
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="Prefix" CssClass="failureNotification"
                            ...
                            <asp:Image ID="Image11" ImageAlign="TextTop" ImageUrl="~/Images/icons/error.png" runat="server" />
                            Please specify a salutation.
                        </asp:RequiredFieldValidator>
                        <asp:CustomValidator ID="CustomValidator6" ControlToValidate="Prefix" CssClass="failureNotification" Display="Dynamic"
                            ...
                            <asp:Image ID="Image12" ImageAlign="TextTop" ImageUrl="~/Images/icons/error.png" runat="server" />
                    ...
                    <%-- Suffix --%>
                    <div class="topPadding">
                        <asp:Label ID="Label7" AssociatedControlID="Suffix" runat="server" Text="Suffix: " />
                        ...
                        <asp:CustomValidator ID="CustomValidator7" ControlToValidate="Suffix" CssClass="failureNotification" Display="Dynamic"
                            ...
                            <asp:Image ID="Image13" ImageAlign="TextTop" ImageUrl="~/Images/icons/error.png" runat="server" />
                    ...
                    <%-- DOB --%>
                    <div class="topPadding">
                        <asp:Label ID="Label8" AssociatedControlID="DateOfBirth" runat="server" Text="* Date of Birth (dd/mm/yyyy): " />
                        ...
                        <ajaxToolkit:CalendarExtender ID="CalendarExtender1" ClearTime="True" DaysModeTitleFormat="dd/MM/yyyy" Enabled="True"
                        ...
                        <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator1" ControlExtender="DOB_Input" ControlToValidate="DateOfBirth"
                        ...
                        <asp:RangeValidator ControlToValidate="DateOfBirth" CssClass="failureNotification"
                            ...
                            <asp:Image ID="Image14" ImageAlign="TextTop" ImageUrl="~/Images/icons/error.png" runat="server" />
                    ...
                    <%-- Address --%>
                    <div class="topPadding">
                        <asp:Label ID="Label9" AssociatedControlID="Address" runat="server" Text="* Address: " />
                        <asp:TextBox CssClass="textEntry" ID="Address" runat="server" TextMode="MultiLine" />
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ControlToValidate="Address" CssClass="failureNotification"
                            Display="Dynamic" ErrorMessage="Please specify an address." runat="server" ToolTip="Please specify an address."
                            ValidationGroup="ValidationGroup">
                            <asp:Image ID="Image15" ImageAlign="TextTop" ImageUrl="~/Images/icons/error.png" runat="server" />
                    ...
                    <%-- Contact Number --%>
                    <div class="topPadding">
                        <asp:Label ID="Label10" AssociatedControlID="ContactNumber" runat="server" Text="* Contact Number: " />
                        ...
                        <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator2" ControlExtender="Contact_Input" ControlToValidate="ContactNumber"
                    ...
                    <%-- Postal Code --%>
                    <div class="topPadding">
                        <asp:Label ID="Label11" AssociatedControlID="PostalCode" runat="server" Text="* Postal Code: " />
                        ...
                        <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator3" ControlExtender="PostalCode_Input" ControlToValidate="PostalCode"
                ...
                <fieldset class="register">
                    ...
                    <div runat="server">
                        ...
                        <asp:RequiredFieldValidator ControlToValidate="UserName" CssClass="failureNotification"
                            ...
                            ToolTip="Please enter your user name." ValidationGroup="ValidationGroup">
                            <asp:Image ImageAlign="TextTop" ImageUrl="~/Images/icons/error.png" runat="server" />
                        ...
                        <asp:CustomValidator ControlToValidate="UserName" CssClass="failureNotification"
                            ...
                            runat="server" ToolTip="User name is already in use." ValidationGroup="ValidationGroup">
                            <asp:Image ImageAlign="TextTop" ImageUrl="~/Images/icons/error.png" runat="server" />
                    ...
                    <div cssclass="topPadding" runat="server">
                        ...
                        <asp:CustomValidator ControlToValidate="Email" CssClass="failureNotification" Display="Dynamic"
                            ...
                            runat="server" ToolTip="Em-ail address is already in use." ValidationGroup="ValidationGroup">
                            <asp:Image ImageAlign="TextTop" ImageUrl="~/Images/icons/error.png" runat="server" />
                    ...
                    <div cssclass="topPadding" runat="server">
                        ...
                        <asp:CompareValidator ControlToCompare="Password" ControlToValidate="ConfirmPassword"
                            ...
                            runat="server" ToolTip="Both passwords must match." ValidationGroup="ValidationGroup">
                            <asp:Image ImageAlign="TextTop" ImageUrl="~/Images/icons/error.png" runat="server" />
            ...
            <%-- / Account Information --%>
            <div runat="server">
                <asp:Button CssClass="buttons" OnClick="RegisterButtonClick" runat="server" Text="Create User"
                    ValidationGroup="ValidationGroup" />
