...
<asp:Content ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div>
        ...
        <asp:ValidationSummary CssClass="failureNotification" runat="server" ValidationGroup="ChangeQuestionValidationGroup" />
        <%-- / Error Notifications --%>
    </div>
    ...
    <div>
        ...
        <asp:Button CausesValidation="False" CssClass="buttons" OnClick="CancelButtonClick" runat="server" Text="Cancel" />
    </div>
</asp:Content>
