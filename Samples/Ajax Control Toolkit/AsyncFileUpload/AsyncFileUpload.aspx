<%@ Page Language="C#" MasterPageFile="~/DefaultMaster.master" AutoEventWireup="true"
    CodeFile="AsyncFileUpload.aspx.cs" Inherits="AsyncFileUpload_AsyncFileUpload"
    Title="AsyncFileUpload Sample" Theme="SampleSiteTheme" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" runat="Server">
    ...
    <div class="demoarea">
        <div class="demoheading">
            AsyncFileUpload Demonstration</div>
    ...
    <asp:Panel ID="Description_ContentPanel" runat="server" Style="overflow: hidden;">
        <p>
            AsyncFileUpload is an ASP.NET AJAX Control that allows you asynchronously upload
            files to server. The file uploading results can be checked both in the server and
            client sides.
        </p>
    </asp:Panel>
    ...
    <asp:Panel ID="Properties_ContentPanel" runat="server" Style="overflow: hidden;"
        ...
        <p>
            ...
            are optional:</p>
        <div style="display: block; margin: 15px 15px 15px 0; padding: 10px; border: 1px dashed #CCC;
            background-color: #FFF; font-family: 'Courier New', Monospace; font-size: 0.9em;
            font-style: normal;">
            <span style="color: blue">&lt;</span><span style="color: #a31515">ajaxToolkit</span><span
                style="color: blue">:</span><span style="color: #a31515">AsyncFileUpload</span>&nbsp;<span
                    style="color: red; font-style: italic">OnClientUploadError</span><span style="color: blue">=&quot;uploadError&quot;<br />
                    </span><span style="color: red; font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;OnClientUploadComplete</span><span
                        style="color: blue">=&quot;uploadComplete&quot;</span>&nbsp;<span style="color: red">runat</span><span
                            style="color: blue">=&quot;server&quot;<br />
                        </span><span style="color: red">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ID</span><span style="color: blue">=&quot;AsyncFileUpload1&quot;</span>
            <span style="color: red; font-style: italic">Width</span><span style="color: blue">=&quot;400px&quot;
            </span><span style="color: red; font-style: italic">UploaderStyle</span><span style="color: blue">=&quot;Modern&quot;<br />
            </span><span style="color: red; font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;UploadingBackColor</span><span
                style="color: blue">=&quot;#CCFFFF&quot;</span><span style="color: red; font-style: italic">&nbsp;ThrobberID</span><span
                    style="color: blue">=&quot;myThrobber&quot;<br />
                    /&gt;</span>
        </div>
        <b>Events</b>
        <ul>
            <li><strong>UploadedComplete</strong> - Fired on the server side when the file successfully
                uploaded</li>
        ...
        <ul>
            ...
            <li><strong>FileContent</strong> - Gets a <span style="color: #2b91af">Stream</span>
                object that points to an uploaded file to prepare for reading the contents of the
                file. </li>
            <li><strong>FileName</strong> - Gets the name of a file on a client to upload using
                the control. </li>
            <li><strong>HasFile</strong> - Gets a <span style="color: #2b91af">bool</span> value
                indicating whether the control contains a file. </li>
            ...
            <li><strong>PostedFile</strong> - Gets a <span style="color: #2b91af">HttpPostedFile</span>
                object that provides access to the uploaded file. </li>
            ...
            <li><strong>UploadingBackColor</strong> - The control's background color when uploading
                is in progress. Default value - <i>'White'</i>.</li>
        ...
        <b>Methods</b>
        <ul>
            <li><strong>SaveAs(<span style="color: #2b91af">string</span> filename)</strong> - Saves
                the contents of an uploaded file. </li>
        </ul>
    </asp:Panel>
